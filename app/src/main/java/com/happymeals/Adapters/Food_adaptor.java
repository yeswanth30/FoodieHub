...
public class Food_adaptor extends RecyclerView.Adapter<Food_adaptor.ViewHolder> {
    ...
    public Food_adaptor(Context context, List<Dish_model> dishes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("ImageUrssssssl", "Image URL: " + dish.getImageurl());
    ...
    private void updateLikeStatus(String dishId, boolean isLiked) {
        ...
        for (Dish_model dish : dishes) {
            if (dish.getDish_id().equals(dishId)) {
                ...
                Log.d("FoodAdapter", "Dish: " + dish.getDish_name() + ", Liked by current user: " + isLiked);
                return;
            }
        }

        Log.e("FoodAdapter", "Dish not found with ID: " + dishId);
    }
